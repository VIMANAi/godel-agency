...
try:
    ...
    from src.core.local_sentiment import cargar_comentarios, analizar_lote_local, verificar_ollama
    from src.core.sensemaker_engine import IndustrialSensemaker
    from src.core.data_ingestion import DataIngestionPipeline, AnonymizationConfig
except ImportError:
    try:
        from core.pdiv_calculator import PDIVCalculator
        from core.local_sentiment import cargar_comentarios, analizar_lote_local, verificar_ollama
        from core.sensemaker_engine import IndustrialSensemaker
        from core.data_ingestion import DataIngestionPipeline, AnonymizationConfig
    except ImportError:
