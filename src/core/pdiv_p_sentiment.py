...
class PSentimentModule:
    ...
    def __init__(self, use_api: bool = False, api_url: Optional[str] = None, api_key: Optional[str] = None):
        ...
        self.spanish_lexicon = {
            # Positivos
            'bueno': 0.6, 'buena': 0.6, 'excelente': 0.9, 'mejor': 0.7, 'lider': 0.8,
            'apoyo': 0.8, 'apoyar': 0.7, 'ganar': 0.8, 'ganador': 0.8, 'triunfo': 0.8,
            'honesto': 0.8, 'honesta': 0.8, 'transparente': 0.8, 'cumple': 0.6,
            'propuesta': 0.5, 'propuestas': 0.5, 'trabajador': 0.7, 'trabajadora': 0.7,
            'gracias': 0.5, 'inteligente': 0.7, 'capaz': 0.7, 'esperanza': 0.8,
            'seguro': 0.6, 'segura': 0.6, 'adelante': 0.6, 'voto': 0.5, 'votar': 0.5,
            
            # Negativos
            'malo': -0.6, 'mala': -0.6, 'peor': -0.8, 'corrupto': -0.9, 'corrupta': -0.9,
            'corrupcion': -0.9, 'mentira': -0.8, 'mentiroso': -0.8, 'mentirosa': -0.8,
            'robar': -0.9, 'robo': -0.9, 'ratero': -0.9, 'ratera': -0.9, 'inutil': -0.8,
            'falso': -0.7, 'falsa': -0.7, 'fraude': -0.9, 'peligro': -0.7, 'peligroso': -0.7,
            'peores': -0.8, 'desastre': -0.8, 'basura': -0.8, 'violencia': -0.8,
            'inseguridad': -0.7, 'mal': -0.5, 'odio': -0.8, 'rechazo': -0.6
        }
