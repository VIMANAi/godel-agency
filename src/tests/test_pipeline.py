...
try:
    ...
    from src.core.pdiv_pipeline import PDIVPipeline
    ...
    try:
        ...
        from core.pdiv_pipeline import PDIVPipeline
        from core.pdiv_calculator import PDIVCalculator
    except ImportError:
        from engine.data_ingestion import DataIngestionPipeline, AnonymizationConfig
...
class PipelineTester:
    ...
    def test_schema_validation(self):
        ...
        success = (
            results['valid_records'] == expected_valid and
            results['invalid_records'] == expected_invalid
        )
    ...
    def test_pdiv_calculation(self):
        ...
        try:
            ...
            checks = [
                ...
                results.loc['Andrea Navarro', 'pdiv_score'] > results.loc['Geraldine Ponce', 'pdiv_score']  # Andrea > Geraldine
            ]
